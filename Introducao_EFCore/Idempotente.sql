...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210116221723_SistemaPedidosMigration_V1')
BEGIN
...
BEGIN
    ...
    VALUES (N'20210116221723_SistemaPedidosMigration_V1', N'3.1.5');
END;
